  ...
  return (
    ...
    >
      ...
      <div style={{ width: "100%", margin: "6px 0" }}>
        ...
        {data.map((item, index) => {
          ...
          return (
            <div key={index} style={{ display: "flex", flexDirection: "row" }}>
              <div style={{ width: `${COL1_WIDTH}%` }}>
                <div style={{ marginVertical: "1px" }}>{itemName}</div>
              </div>
              <div style={{ width: `${COLN_WIDTH}%` }}>
                <div style={{ marginVertical: "1px" }}>
                  {formatNumber(unitPrice)}
                </div>
              </div>
              <div style={{ width: `${COLN_WIDTH}%` }}>
                <div style={{ marginVertical: "1px" }}>{formatNumber(qty)}</div>
              </div>
              <div style={{ width: `${COL_AMT_WIDTH}%` }}>
                <div style={{ marginVertical: "1px", textAlign: "right" }}>
                  {formatNumber(amount)}
                </div>
              </div>
            </div>
        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
          <div style={{ width: `${COL1_WIDTH}%` }}>
            <div style={{ marginVertical: "1px" }}>Total</div>
          </div>
          <div style={{ width: `${COLN_WIDTH}%` }}>
            <div style={{ marginVertical: "1px" }}></div>
          </div>
          <div
            style={{
              width: `${2 * COLN_WIDTH}%`,
        ...
        {parseInt(String(discount)) > 0 && (
          ...
          >
            <div style={{ width: `${COL1_WIDTH}%` }}>
              <div style={{ marginVertical: "1px" }}>Discount</div>
            </div>
            <div style={{ width: `${COLN_WIDTH}%` }}>
              <div style={{ marginVertical: "1px" }}></div>
            </div>
        ...
        >
          <div style={{ width: `${COL1_WIDTH}%` }}>
            <div style={{ marginVertical: "1px" }}>Amount Paid</div>
          </div>
          <div style={{ width: `${COLN_WIDTH}%` }}>
            <div style={{ marginVertical: "1px" }}></div>
          </div>
        ...
        {paymentStatus !== "Full Payment" && (
          <div style={{ display: "flex", flexDirection: "row" }}>
            <div style={{ width: `${COL1_WIDTH}%` }}>
              <div style={{ marginVertical: "1px" }}>Grand Total</div>
            </div>
            <div style={{ width: `${COLN_WIDTH}%` }}>
              <div style={{ marginVertical: "1px" }}></div>
            </div>
        ...
        {paymentStatus !== "Full Payment" && (
          ...
          >
            <div style={{ width: `${COL1_WIDTH}%` }}>
              <div style={{ marginVertical: "1px" }}>Balance</div>
            </div>
            <div style={{ width: `${COLN_WIDTH}%` }}>
              <div style={{ marginVertical: "1px" }}></div>
            </div>
