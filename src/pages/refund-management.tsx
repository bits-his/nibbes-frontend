...
import { FileText, CheckSquare, CreditCard, AlertTriangle, BarChart3 } from 'lucide-react';
...
export default function RefundManagement() {
  ...
  const sections = [
    ...
    {
      title: 'Misconduct Cards',
      description: 'Track and resolve employee misconduct cards',
      icon: AlertTriangle,
  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">Manage refunds, store credits, and staff accountability</p>
      </div>
