      ...
      <Page size={{ width: 200 }} style={styles.body}>
        <View>
          <View style={styles.headerContainer}>
            <Image style={styles.image} src={facilityInfo.logo} />
          ...
          {modeOfPayment === "Deposit" ? (
            <View style={styles.item}>
              ...
              <View>
                {/* <Text>{name}</Text> */}
                <Text>{name === "" ? "Walk-In" : `${name}(${patient_id})`}</Text>
              </View>
            </View>
          ) : null}
          <View style={styles.item}>
              ...
              <View key={index} style={styles.tableRow}>
                ...
                <View style={styles.tableCol}>
                  <Text style={[styles.tableCell]}>
                    {formatNumber(item.amount / parseInt(item.qty || 1))}
                  </Text>
                </View>
                <View style={styles.tableCol}>
                  <Text style={[styles.tableCell]}>
        ...
        <Text style={styles.poweredBy}>Powered by: mylikita.com</Text>
      </Page>
    </Document>
  );
};
